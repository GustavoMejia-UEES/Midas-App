...
const Home = () => {
  const features = [
    {
      title: 'Asistente IA',
      description: 'Chatea con nuestro asistente inteligente para resolver tus dudas financieras',
      icon: ChatBubbleLeftRightIcon,
    },
    {
      title: 'Educación',
      description: 'Aprende sobre finanzas con nuestro contenido educativo interactivo',
      icon: AcademicCapIcon,
    },
    {
      title: 'Análisis',
      description: 'Obtén insights valiosos sobre tus finanzas personales',
      icon: ChartBarIcon,
    },
  ];
